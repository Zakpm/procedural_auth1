    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST"){
        ...
        $errors = make_validation(
            ...
            [
                ...
                "email.min"           => "L'email doit contenir au moins 5 caractères.",
                ...
                "password.regex"      => "Le mot de passe doit contenir au moin une lettre minuscule, une lettre majuscule, un chiffre et un caractère spécial."
