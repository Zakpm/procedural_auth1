 ...
 */
 ...
 /**
  * Cette fonction du routeur lui permet de récupérer chaque route dont l'application attend la réception via la méthode "GET" 
  *
 ...
 /**
  * Cette fonction du routeur lui permet de récupérer chaque route dont l'application attend la réception via la méthode "POST" 
  *
  * @param string $request_route
  * @param array $action_route
  * @return void
...
/**
 * Cette méthode collecte les routes dont l'application attend la réception via la méthode "GET" et "POST"
 * Elle stock ensuite ces routes dans un tableau à route en prenant soin de les trier par méthode d'envoi
 * 
 * @param string $method
 * @param string $request_route
 * @param array $action_route
