 ...
 * respecte l'expressionrégulière prévue par le système.
 *
 * @param string $value
 * @param string $rule
 * @return boolean
...
/**
 * Cette fonction vérifie si la valeur envoyée par l'utilisateur 
 * existe déjà dans la table ciblée de la base de données ou non.
 *
 * @param string $value
 * @param string $rule
 * @return boolean
...
/**
 * Cette fonction vérifie si la valeur envoyée par l'utilisateur 
 * est inférieure ou non à celle prévue par le système.
 *
 * @param string $value
 * @param string $rule
 * 
...
/**
 * Cette fonction vérifie si la valeur envoyée par l'utilisateur 
 * est supérieure à celle prévue par le système.
 *
 * @param string $value
 * @param string $rule
 * 
...
/**
 * Cette fonction protège le serveur contre de l'injection de code sous forme de scrips malveillants
 *
 * @param array $data
 * 
 * @return void
